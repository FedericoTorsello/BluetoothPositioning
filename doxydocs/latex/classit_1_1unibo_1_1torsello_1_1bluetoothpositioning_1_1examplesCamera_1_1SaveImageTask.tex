...
28                                                   \{
29 
30         \textcolor{comment}{// Write to SD Card}
31         \textcolor{keywordflow}{try} \{
32             File sdCard = Environment.getExternalStorageDirectory();
33             File dir = \textcolor{keyword}{new} File(sdCard.getAbsolutePath() + \textcolor{stringliteral}{"/camtest"});
34 \textcolor{comment}{//                    dir.mkdirs();}
35 
36             String fileName = String.format(Locale.getDefault(), \textcolor{stringliteral}{"%d.jpg"}, System.currentTimeMillis());
37             File outFile = \textcolor{keyword}{new} File(dir, fileName);
38 
39             FileOutputStream outStream = \textcolor{keyword}{new} FileOutputStream(outFile);
40             outStream.write(data[0]);
41             outStream.flush();
42             outStream.close();
43 
44             Log.d(\hyperlink{classit_1_1unibo_1_1torsello_1_1bluetoothpositioning_1_1examplesCamera_1_1SaveImageTask_a908ad84901185def0257ea5288f64c3c_a908ad84901185def0257ea5288f64c3c}{TAG}, \textcolor{stringliteral}{"onPictureTaken - wrote bytes: "} + data.length + \textcolor{stringliteral}{" to "} + outFile.getAbsolutePath
      ());
45 
46             \hyperlink{classit_1_1unibo_1_1torsello_1_1bluetoothpositioning_1_1examplesCamera_1_1SaveImageTask_a8bcd9bba7269b952dd0a06bdc3381c25_a8bcd9bba7269b952dd0a06bdc3381c25}{refreshGallery}(outFile);
47         \} \textcolor{keywordflow}{catch} (IOException e) \{
