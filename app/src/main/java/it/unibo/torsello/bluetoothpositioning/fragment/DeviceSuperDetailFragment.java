 ...
 */
public class DeviceSuperDetailFragment extends Fragment implements ApplicationActivity.OnAddDevicesListener {
...
//    private CameraUtil cameraUtil;
    ...
    public static DeviceSuperDetailFragment newInstance(String message) {
        DeviceSuperDetailFragment fragment = new DeviceSuperDetailFragment();
...
//        initializeCamera(root);
        ...
        fragments.add(DeviceInnerDetailFragment.newInstance(idDeviceSelectedName));
