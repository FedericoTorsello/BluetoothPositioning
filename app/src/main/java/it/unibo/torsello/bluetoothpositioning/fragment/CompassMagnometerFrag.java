...
public class CompassMagnometerFrag extends Fragment implements Magnetometer.OnCompassOrientationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.myfragment_frag, container, false);
