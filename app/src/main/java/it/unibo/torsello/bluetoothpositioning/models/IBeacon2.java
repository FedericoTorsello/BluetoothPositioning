...
//	protected static IBeaconDataFactory iBeaconDataFactory = new NullIBeaconDataFactory();
    ...
    public boolean equals(Object that) {
        ...
        IBeacon2 thatIBeacon = (IBeacon2) that;
     ...
     */
    @TargetApi(5)
    public static IBeacon2 fromScanData(byte[] scanData, int rssi, BluetoothDevice device) {
        int startByte = 2;
...
//	}
    ...
    protected IBeacon2(IBeacon2 otherIBeacon) {
    ...
    protected IBeacon2(String proximityUuid, int major, int minor, int txPower, int rssi) {
    ...
    public IBeacon2(String proximityUuid, int major, int minor) {
        this.proximityUuid = proximityUuid.toLowerCase();
        this.major = major;
        this.minor = minor;
        this.rssi = rssi;
