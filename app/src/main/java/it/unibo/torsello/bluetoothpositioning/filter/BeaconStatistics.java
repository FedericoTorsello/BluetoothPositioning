...
public class BeaconStatistics {
    ...
    public void updateDistance(IBeacon b, double movementState, double txPower, double processNoise) {
        double lastFilteredReading = -1;

        mostRecentRSSI.addValue(b.getLastRssi());
        ...
        lastRawDistance = calculateDistance(b.txPower, b.getLastRssi());
        lastWOSC = calculateDistance(b.txPower, lastFilteredReading);
    }
